...

{
  ...
  # silent NXDOMAIN. It costs tailnet names in the system resolver: nothing
  # resolving through glibc on pc, containers included, can look up a tailnet
  # host. tailscaled's own resolver still answers them. See docs/dns.md.
